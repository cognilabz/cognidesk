...
| <a id="property-credentialrequirements"></a> `credentialRequirements` | \{ `description`: `string`; `id`: `string`; `label`: `string`; `metadata`: \{ `minimumAccess`: `string`[]; `projectScoped`: `boolean`; `scopeModel`: `string`; \}; `required`: `true`; \}[] |
...
| `metadata.channelCoverage.realtimeAudio` | `string` |
| `metadata.channelCoverage.realtimeToolCalls` | `string` |
...
| `coverage.notes` | `string`[] |
| `coverage.scope` | `"provider-api-subset"` |
| `credentialRequirements` | \{ `description`: `string`; `id`: `string`; `label`: `string`; `metadata`: \{ `minimumAccess`: `string`[]; `projectScoped`: `boolean`; `scopeModel`: `string`; \}; `required`: `true`; \}[] |
| `directions` | `"bidirectional"`[] |
| `id` | `string` |
| `limitations` | `string`[] |
