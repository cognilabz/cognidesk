# integrations/voice/azure-speech/dist/manifest

## Variables

### azureSpeechManifestInput

```ts
const azureSpeechManifestInput: {
  capabilities: (
     | {
...
Re-exports [azureSpeechIntegration](../dist.md#azurespeechintegration)

***

### azureSpeechProviderManifest

Re-exports [azureSpeechProviderManifest](../dist.md#azurespeechprovidermanifest)
