...
| `metadata` | \{ `channelCoverage`: \{ `broaderIntercomApi`: `"provider-supported-raw-client"`; `conversations`: `"typed-reply-read-extension"`; `internalNotes`: `"typed-conversation-note"`; `tickets`: `"typed-create-read-update-search"`; \}; `implementation`: \{ `manifestImport`: `"no-sdk-client-initialization"`; `rawClientEscapeHatch`: `"IntercomTicketingClient.rawClient/getRawClient()"`; `sdkPackage`: `"intercom-client"`; `sdkVersionRange`: `"7.0.3"`; `strategy`: `"official-sdk"`; `supplyChainNote`: `"7.0.3 is pinned; do not allow compromised 7.0.4."`; \}; \} |
...
| `metadata.implementation` | \{ `manifestImport`: `"no-sdk-client-initialization"`; `rawClientEscapeHatch`: `"IntercomTicketingClient.rawClient/getRawClient()"`; `sdkPackage`: `"intercom-client"`; `sdkVersionRange`: `"7.0.3"`; `strategy`: `"official-sdk"`; `supplyChainNote`: `"7.0.3 is pinned; do not allow compromised 7.0.4."`; \} |
| `metadata.implementation.manifestImport` | `"no-sdk-client-initialization"` |
| `metadata.implementation.rawClientEscapeHatch` | `"IntercomTicketingClient.rawClient/getRawClient()"` |
