...
| `metadata.implementation` | \{ `manifestImport`: `"no-sdk-client-initialization"`; `rawClientEscapeHatch`: `"SalesforceTicketingClient.rawClient and getRawClient()"`; `sdkPackage`: `"jsforce"`; `sdkVersionRange`: `"^3.10.16"`; `strategy`: `"maintained-library"`; \} |
| `metadata.implementation.manifestImport` | `"no-sdk-client-initialization"` |
| `metadata.implementation.rawClientEscapeHatch` | `"SalesforceTicketingClient.rawClient and getRawClient()"` |
