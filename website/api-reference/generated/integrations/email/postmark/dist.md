...
| `metadata?` | `Record`\<`string`, `unknown`\> |
| `operationAliases` | ( \| `"email.receive"` \| `"email.reply.send"` \| `"email.send"` \| `"email.deliveryStatus.read"` \| `"postmark.messageStreams.list"` \| `"postmark.suppressions.create"` \| `"postmark.suppressions.delete"`)[] |
