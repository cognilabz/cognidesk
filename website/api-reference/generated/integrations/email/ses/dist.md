...
```ts
sendRawEmail(input): Promise<unknown>;
```
...
```ts
optional ses?: Pick<SESClient, "send">;
```
...
function createSesEmailIntegration(options): {
  ...
  manifest: {
     ...
     credentialRequirements: readonly [{
        ...
        required: true;
        scopes: readonly ["ses:SendEmail", "ses:GetAccount", "ses:ListEmailIdentities", "ses:DeleteSuppressedDestination"];
      }, {
