...
| `input.request` | \{ `actionAudience?`: `"customer-facing"` \| `"internal-support"` \| `"mixed"`; `capability`: `string`; `changesWorkflow?`: `boolean`; `channel`: `string`; `exposesSensitiveData?`: `boolean`; `externallyVisible?`: `boolean`; `outbound?`: `boolean`; `providerPackageId?`: `string`; `requiredPolicyIds?`: `string`[]; `sideEffect?`: `boolean`; \} |
