...
import { channelKindOf } from "../../types.js";
...
import { enterStateTree, stateRequirementsSatisfied } from "./entry.js";
import { applyStateExtraction } from "./extraction.js";
import type {
  RuntimeEmit,
  StateMachineDeps,
} from "./types.js";
...
export async function advanceStateMachine(args: StateMachineDeps & {
  ...
  while (!visited.has(state.id)) {
    ...
    const voiceMode = channelKindOf(args.channel) === "voice";
