...
} from "../../../src/ticketing/zoho-desk/index.js";
...
describe("@cognidesk/integrations", () => {
  ...
  it("declares docs-backed scoped Zoho Desk coverage", () => {
    ...
    const coverage = readProviderCoverageArtifact("docs/provider-coverage/zoho-desk-checked-rest-api-2026-06-18.inventory.json");
