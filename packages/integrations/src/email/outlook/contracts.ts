...
export interface OutlookEmailProviderResponse extends OutlookEmailJsonObject {}
...
export interface OutlookGraphOperationRequestInput extends OutlookProviderRequestOptions {
...
export interface OutlookEmailClient {
  graphApi: OutlookGraphGeneratedClient;
  requestOperation: OutlookGraphGeneratedOperationCaller;
