...
```bash
npm install @cognidesk/integration-voice-sip
```
...
```ts
import * as providerManifest from "@cognidesk/integration-voice-sip/manifest";
```
...
- `@cognidesk/integration-voice-sip`
- `@cognidesk/integration-voice-sip/manifest`
- `@cognidesk/integration-voice-sip/runtime`
