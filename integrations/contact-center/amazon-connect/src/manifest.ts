  ...
  operations: [
    {
      ...
      providerObject: "amazonConnectTaskContact",
      sideEffect: true,
      exposesSensitiveData: true,
      changesWorkflow: true,
    },
    ...
    },
    {
      ...
      providerObject: "amazonConnectChatContact",
      sideEffect: true,
      exposesSensitiveData: true,
      changesWorkflow: true,
    },
    {
      ...
      providerObject: "amazonConnectContactTransfer",
      sideEffect: true,
      exposesSensitiveData: true,
      changesWorkflow: true,
    },
    {
      ...
      providerObject: "amazonConnectChatTranscript",
      exposesSensitiveData: true,
    },
  ],
  privacyNotes: [
