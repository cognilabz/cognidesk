...
```bash
npm install @cognidesk/integration-email-smtp
```
...
```ts
import * as providerManifest from "@cognidesk/integration-email-smtp/manifest";
```
...
- `@cognidesk/integration-email-smtp`
- `@cognidesk/integration-email-smtp/manifest`
- `@cognidesk/integration-email-smtp/runtime`

## Links

- Documentation: https://cognidesk.cognilabz.com
- Repository: https://github.com/cognilabz/cognidesk/tree/main/integrations/email/smtp
- License: Apache-2.0
