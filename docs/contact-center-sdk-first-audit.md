...
- `manifestOnlySafe`: a test proving `@cognidesk/integration-contact-center-*/manifest` does not import generated clients, fetch implementations, or provider SDK runtimes.
